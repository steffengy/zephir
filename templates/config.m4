...
if test "$PHP_%PROJECT_UPPER%" = "yes"; then
	...
	%PROJECT_LOWER%_sources="%PROJECT_LOWER_SAFE%.c kernel/main.c kernel/exception.c kernel/memory.c kernel/object.c kernel/array.c kernel/string.c kernel/fcall.c kernel/require.c kernel/file.c kernel/operators.c kernel/concat.c kernel/variables.c kernel/iterator.c kernel/exit.c %FILES_COMPILED% %EXTRA_FILES_COMPILED%"
