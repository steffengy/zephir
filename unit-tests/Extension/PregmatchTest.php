...
class PregMatchTest extends \PHPUnit_Framework_TestCase
{
    public function testPregMatch()
    {
        ...
        /* TODO ref-param: Cant work without references:  
        ...
        */
        ...
        //TODO ref-param: $this->assertCount(0, $match2);

        $match3 = null;
        $this->assertSame(1, $t->testPregMatch3Params('/\[\*\],\s(.*)/', $string, $match3)); //finds "[*], this is \ a string";
        //TODO ref-param: $this->assertCount(2, $match3);
