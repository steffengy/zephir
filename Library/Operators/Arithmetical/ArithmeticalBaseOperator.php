                    ...
                    case 'variable':
                        ...
                        switch ($variableRight->getType()) {
                            ...
                            case 'variable':
                                ...
                                return new CompiledExpression('int', '(' . $left->getCode() . ' ' . $this->_operator . ' zephir_get_numberval(' . $variableRight->getPointeredName() . '))', $expression);
                                break;
                ...
                switch ($right->getType()) {
                    ...
                    case 'variable':
                        ...
                        switch ($variableRight->getType()) {
                            ...
                            case 'variable':
                                $compilationContext->headersManager->add('kernel/operators');
                                return new CompiledExpression('double', '(' . $left->getCode() . ' ' . $this->_operator . ' zephir_get_numberval(' . $variableRight->getPointeredName() . '))', $expression);
                                break;
                        ...
                        switch ($right->getType()) {
                            ...
                            case 'variable':
                                ...
                                switch ($variableRight->getType()) {
                                    ...
                                    case 'variable':
                                        $compilationContext->headersManager->add('kernel/operators');
                                        return new CompiledExpression('int', '(' . $variableLeft->getName() . ' ' . $this->_operator . ' zephir_get_numberval(' . $variableRight->getPointeredName() . '))', $expression);
                                        break;
                        ...
                        switch ($right->getType()) {
                            ...
                            case 'variable':
                                ...
                                switch ($variableRight->getType()) {
                                    ...
                                    case 'ulong':
                                        $compilationContext->headersManager->add('kernel/operators');
                                        return new CompiledExpression('int', '(zephir_get_numberval(' . $variableLeft->getPointeredName() . ') ' . $this->_operator . ' ' . $variableRight->getName() . ')', $expression);
                                        break;
