...
class StaticConstantAccess
{
    ...
    public function compile($expression, CompilationContext $compilationContext)
    {
        ...
        if (!$compilationContext->config->get('static-constant-class-folding', 'optimizations')) {
            ...
            $compilationContext->codePrinter->output('zephir_get_class_constant(' . $symbolVariable->getPointeredName() . ', ' . $classDefinition->getClassEntry($compilationContext) . ', SS("' . $constant . '") TSRMLS_CC);');
